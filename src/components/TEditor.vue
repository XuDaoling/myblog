...
const props = defineProps({
  ...
  toolbar: {
    ...
    default: "undo redo | accordion accordionremove | blocks fontfamily fontsize| bold italic underline strikethrough ltr rtl  | align numlist bullist | table | lineheight outdent indent| charmap emoticons | anchor codesample",
  },
  readonly: {
    type: Boolean,
    default: false,
